...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('transition',{attrs:{"name":"mv-dialog-fade"}},[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.visible),expression:"visible"}],staticClass:"mv-dialog-wrap",class:_vm.positionClass,style:({'z-index': _vm.zIndex}),on:{"click":function($event){if($event.target !== $event.currentTarget){ return null; }return _vm.handleWrapClick()}}},[_c('div',{staticClass:"mv-dialog",style:(_vm.style)},[_c('div',{staticClass:"mv-dialog-header"},[_vm._t("title",[_c('div',{staticClass:"mv-dialog-title"},[_vm._v(_vm._s(_vm.title))])]),_c('div',{staticClass:"mv-dialog-close",on:{"click":_vm.handleClose}},[_c('mv-icon',{attrs:{"name":"mv-close"}})],1)],2),_c('div',{staticClass:"mv-dialog-body"},[_vm._t("default")],2),(_vm.$slots.footer)?_c('div',{staticClass:"mv-dialog-footer"},[_vm._t("footer")],2):_vm._e()])])])}
var staticRenderFns = []
